<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ISSUE_Summary_Report.aspx.cs" Inherits="NLN_Linen.Views.REPORT.ISSUE_Summary_Report" %>
                    ...
                    <div class="container">
                        ...
                        <div>
                            <fieldset class="scheduler-border">
                                <legend class="scheduler-border">Issue Summary Criteria : Search</legend>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <asp:DropDownList ID="DDLReportType" runat="server" CssClass="form-control" Width="280px">
                                                    <asp:ListItem Text="Summary Existing" Value="A"></asp:ListItem>
                                                    <asp:ListItem Text="Summary Detail" Value="B"></asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
