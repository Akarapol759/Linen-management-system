<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ISSUE_Billing_Report.aspx.cs" Inherits="NLN_Linen.Views.REPORT.ISSUE_Billing_Report" %>
                    ...
                    <div class="container">
                        ...
                        <div>
                            <fieldset class="scheduler-border">
                                <legend class="scheduler-border">Issue Billing Criteria : Search</legend>
                                <div class="form-horizontal">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                <asp:Label runat="server" Text="Category Group : " CssClass="col-md-5 control-label"></asp:Label>
                                                <div class="col-md-7">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    <asp:DropDownList ID="DDLReportType" runat="server" CssClass="form-control" Width="280px">
                                                        <asp:ListItem Text="Billing Existing" Value="A"></asp:ListItem>
                                                        <asp:ListItem Text="Billing Detail" Value="B"></asp:ListItem>
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                        </div>
