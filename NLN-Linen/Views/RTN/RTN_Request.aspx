<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RTN_Request.aspx.cs" Inherits="NLN_Linen.Views.RTN.RTN_Request" %>
                    ...
                    <div class="container">
                        ...
                        <div>
                            <fieldset class="scheduler-border">
                                <legend class="scheduler-border">Return Criteria : Search</legend>
                                <div class="form-horizontal">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                <asp:Label runat="server" Text="RTN Request No. : " CssClass="col-md-5 control-label"></asp:Label>
                                                <div class="col-md-7">
                                                    <asp:TextBox ID="txtSearchRTNRequestNo" runat="server" CssClass="form-control"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    <asp:DropDownList ID="DDLRTNStatus" runat="server" CssClass="form-control">
                                    ...
                                    <ContentTemplate>
                                        <asp:GridView ID="GridView" runat="server" HorizontalAlign="Center" PageSize="10" Width="100%"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="RTN_REQUEST_NO" HeaderText="RTN Request No." />
                                                <asp:BoundField DataField="CUS_NAME" HeaderText="Department Name" />
                                                <asp:BoundField DataField="CREATE_DATE" HeaderText="Return Date" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg" />
                                                <asp:BoundField DataField="RTN_REQUEST_STATUS_NAME" HeaderText="Status" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg" />
                                            </Columns>
                                        </asp:GridView>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
