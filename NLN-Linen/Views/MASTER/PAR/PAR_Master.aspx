<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PAR_Master.aspx.cs" Inherits="NLN_Linen.Views.MASTER.PAR.PAR_Master" %>
                    ...
                    <div class="container">
                        ...
                        <div>
                            <fieldset class="scheduler-border">
                                <legend class="scheduler-border">Par Master Criteria : Search</legend>
                                    ...
                                    <ContentTemplate>
                                        <asp:GridView ID="GridView" runat="server" HorizontalAlign="Center" PageSize="10" Width="100%"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="CUS_ID" HeaderText="CUS_ID" Visible="false" />
                                                <asp:BoundField DataField="BU_CODE" HeaderText="Bu Code"/>
