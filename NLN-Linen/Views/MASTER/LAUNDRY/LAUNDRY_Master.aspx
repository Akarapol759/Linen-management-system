<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LAUNDRY_Master.aspx.cs" Inherits="NLN_Linen.Views.MASTER.LAUNDRY.LAUNDRY_Master" %>
                    ...
                    <div class="container">
                        ...
                        <div>
                            <fieldset class="scheduler-border">
                                <legend class="scheduler-border">Laundry Master Criteria : Search</legend>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    <asp:DropDownList ID="DDLLaundryStatus" runat="server" CssClass="form-control" Width="280px">
                                ...
                                <asp:UpdatePanel ID="UpdatePanel" runat="server">
                                    <ContentTemplate>
                                        <asp:GridView ID="GridView" runat="server" HorizontalAlign="Center" PageSize="10" Width="100%"
                                            ...
                                            DataKeyNames="LAUNDRY_ID" CssClass="table table-striped table-bordered table-hover footable"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="LAUNDRY_ID" HeaderText="Id" Visible="false" />
                                                <asp:BoundField DataField="BU_SHORT_NAME" HeaderText="Business Unit" />
                                                <asp:BoundField DataField="LAUNDRY_CODE" HeaderText="Laundry Code" />
                                                <asp:BoundField DataField="LAUNDRY_NAME" HeaderText="Laundry Name" />
                                                <asp:BoundField DataField="LAUNDRY_STATUS_NAME" HeaderText="Status"/>
                                            </Columns>
                                        </asp:GridView>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
