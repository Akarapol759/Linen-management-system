<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CUSTOMER_Edit_Master.aspx.cs" Inherits="NLN_Linen.Views.MASTER.CUSTOMER.CUSTOMER_Edit_Master" %>
                    ...
                    <div class="container">
                        ...
                        <div>
                            <fieldset class="scheduler-border">
                                <legend class="scheduler-border">Department Master : Edit</legend>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    <asp:TextBox ID="txtCusCode" runat="server" CssClass="form-control" Enabled="false">
                                                    </asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
