<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CYCLE_Master.aspx.cs" Inherits="NLN_Linen.Views.MASTER.CYCLE.CYCLE_Master" %>
                    ...
                    <div class="container">
                        ...
                        <div>
                            <fieldset class="scheduler-border">
                                <legend class="scheduler-border">Cycle Master Criteria : Search</legend>
                                <div class="form-horizontal">
                                    <div class="row">
                                        ...
                                        <%--<div class="col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                <asp:Label runat="server" Text="Laundry Code : " CssClass="col-md-5 control-label"></asp:Label>
                                                <div class="col-md-7">
                                                    <asp:TextBox ID="txtLaundryCode" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="DDLBusinessUnit_SelectedIndexChanged">
                                                    </asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    <asp:TextBox ID="txtLaundryName" runat="server" CssClass="form-control">
                                                    </asp:TextBox>
                                                </div>
                                            </div>
                                        </div>--%>
                                        ...
                                        <div class="col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    <asp:DropDownList ID="DDLCycleStatus" runat="server" CssClass="form-control" Width="280px">
                                                        <asp:ListItem Text="All" Value="-1"></asp:ListItem>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel" runat="server">
                                    <ContentTemplate>
                                        <asp:GridView ID="GridView" runat="server" HorizontalAlign="Center" PageSize="10" Width="100%"
                                            ...
                                            DataKeyNames="CYCLE_ID" CssClass="table table-striped table-bordered table-hover footable"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="CYCLE_ID" HeaderText="Id" Visible="false" />
                                                <asp:BoundField DataField="BU_SHORT_NAME" HeaderText="Business Unit" />
                                                <asp:BoundField DataField="CYCLE_TYPE_NAME" HeaderText="Cycle Type" />
                                                <asp:BoundField DataField="CYCLE_TIME" HeaderText="Cycle Time" />
                                                <asp:BoundField DataField="CYCLE_STATUS_NAME" HeaderText="Status"/>
                                            </Columns>
                                        </asp:GridView>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
