<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="USER_Master.aspx.cs" Inherits="NLN_Linen.Views.MASTER.USER.USER_Master" %>
                    ...
                    <div class="container">
                        ...
                        <div>
                            <fieldset class="scheduler-border">
                                <legend class="scheduler-border">User Master Criteria : Search</legend>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    <asp:TextBox ID="txtUserCode" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="DDLBusinessUnit_SelectedIndexChanged">
                                                    </asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    <asp:DropDownList ID="DDLUserStatus" runat="server" CssClass="form-control" Width="280px">
                                ...
                                <asp:UpdatePanel ID="UpdatePanel" runat="server">
                                    <ContentTemplate>
                                        <asp:GridView ID="GridView" runat="server" HorizontalAlign="Center" PageSize="10" Width="100%"
                                            ...
                                            DataKeyNames="USER_ID" CssClass="table table-striped table-bordered table-hover footable"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="USER_ID" HeaderText="Id" SortExpression="USER_ID" Visible="false" />
